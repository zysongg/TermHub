...
import { news as dataNews } from '../data'

const MotionBox = motion(Box)

const sortNews = (arr: typeof dataNews) => {
  return [...arr].sort((a, b) => {
  ...
  return (
    <Container maxW="7xl" px={4}>
      <VStack spacing={8} align="stretch">
        ...
        >
          <Heading as="h1" size="xl" mb={6}>News</Heading>
          <Box className="meta">
        ...
        >
          <Heading as="h2" size="lg" mb={4}>Current Focus</Heading>
