          ...
          <VStack spacing={[2, 3]} align={['center', 'center', 'flex-start']} flex="1">
            ...
            <Flex w="full" direction={['column', 'column', 'row']} align={['center', 'center', 'center']} gap={[2, 2, 4]}>
              <Text fontSize="xs" color={textColor} lineHeight="tall" textAlign={['center', 'center', 'left']} flex={1}>
                I am a researcher working on long-term time series forecasting and 5G wireless channel prediction, with recent work on frequency-domain decomposition, period-aware regularization, and diffusion-based spatio-temporal Transformer models.
              </Text>
